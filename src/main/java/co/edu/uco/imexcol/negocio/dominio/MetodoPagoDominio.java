...
public final class MetodoPagoDominio extends Dominio {
    ...
    public MetodoPagoDominio(final UUID id) {
        super(id);
        setNombre(UtilTexto.VACIO);
        setDescripcion(UtilTexto.VACIO);
        setEstado(UtilBooleano.obtenerValorPorDefecto());
    ...
    public MetodoPagoDominio(final UUID id, final String nombre, final String descripcion, final boolean estado) {
        super(id);
        setNombre(nombre);
