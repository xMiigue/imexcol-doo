...
public final class ItemCarritoFachadaImpl implements ItemCarritoFachada {
    ...
    private final ItemCarritoNegocio negocio;
    private final ItemCarritoDTOAssembler ensamblador;

    public ItemCarritoFachadaImpl() {
        super();
        // TODO: integrar con DAOFactory — instanciar ItemCarritoNegocioImpl(daoFactory) cuando exista la capa de datos.
        this.negocio = new ItemCarritoNegocioImpl();
